...
from sentinel_dv.schemas.tests import TestCase, TestStatus, TestTopology, UvmTopology, InterfaceBinding
...
from sentinel_dv.utils.bounded_text import truncate_text, extract_excerpt
...
class UVMLogParser:
    ...
    def _parse_time(self, time_str: str, unit: Optional[str]) -> Optional[int]:
        """
    ...
    def _extract_phase(self, message: str) -> Optional[str]:
    ...
    def _extract_topology(self, content: str) -> Optional[TestTopology]:
        """
