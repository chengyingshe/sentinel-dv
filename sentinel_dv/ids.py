...
def generate_run_id(
    ...
    artifact_manifest: Optional[list[tuple[str, str]]] = None,
) -> tuple[str, str]:
    """
...
def generate_test_id(
    ...
    simulator_vendor: Optional[str] = None,
    simulator_version: Optional[str] = None,
    dut_top: Optional[str] = None,
...
def generate_failure_id(
    ...
    evidence_paths: Optional[list[tuple[str, int, int]]] = None,
) -> tuple[str, str]:
    """
