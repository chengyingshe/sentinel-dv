...
Sentinel DV is open source software licensed under the Apache License 2.0.
...
- ✅ **Use** Sentinel DV for any purpose (commercial or non-commercial)
- ✅ **Modify** the source code
- ✅ **Distribute** copies of Sentinel DV
- ✅ **Distribute modified versions** of Sentinel DV
- ✅ **Grant patent rights** from contributors to users

Under these conditions:

- 📋 **Include the license** in all copies or substantial portions
- 📋 **State changes** made to the original code
- 📋 **Include the NOTICE file** if one exists in the distribution
- 🚫 **No trademark use** without explicit permission
- 🚫 **No warranty** - software is provided "as is"

## Third-Party Licenses

Sentinel DV depends on the following open source packages:
